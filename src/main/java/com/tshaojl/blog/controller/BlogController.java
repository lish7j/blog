...
import com.tshaojl.blog.service.EsBlogService;
    ...
    public String listEsBlogs(
        ...
        try {
            if (order.equals("hot")) { // 最热查询
                ...
                Pageable pageable = PageRequest.of(pageIndex, pageSize, readSizeSorter);
                page = esBlogService.listHotestEsBlogs(keyword, pageable);
            } else if (order.equals("new")) { // 最新查询
                // Sort sort = new Sort(Direction.DESC, "createTime");
                Sort createTimeSorter = Sort.by("createTime").descending();
                Pageable pageable = PageRequest.of(pageIndex, pageSize, createTimeSorter);
